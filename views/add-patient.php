        ...
        <div class="container d-flex justify-content-center flex-column bg-light shadow-lg mt-2 bg-img">
            <div class="row flex-column align-items-center">
                <div class="col-lg-6 mb-3 mt-3">
                    ...
                    <input name="lastname" type="text" class="form-control" value="<?=htmlentities($lastname ?? '')?>" 
                    pattern="<?=STRING_REGEX?>" id="lastname" aria-describedby="lastname">
                    <p class="text-danger"><?=$error['lastname'] ?? NULL?></p>
                </div>

                <div class="col-lg-6 mb-3">
                    <label for="firstname" class="form-label">Prénom :</label>
                    <input name="firstname" type="text" class="form-control" value="<?=htmlentities($firstname ?? '')?>" 
                    pattern="<?=STRING_REGEX?>" id="firstname" aria-describedby="firstname">
                    <p class="text-danger"><?=$error['firstname'] ?? NULL?></p>
                </div>

                <div class="col-lg-6 mb-3">
                    <label for="birthdate" class="form-label">Naissance :</label>
                    <input name="birthdate" type="date" class="form-control" value="<?=htmlentities($birthdate ?? '')?>" 
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input name="phone" type="tel" class="form-control" value="<?=htmlentities($phone ?? '')?>" 
                    pattern="<?=PHONE_REGEX?>" id="phone" aria-describedby="phone">
                    <p class="text-danger"><?=$error['phone'] ?? NULL?></p>
                </div>

                <div class="col-lg-6 mb-3">
                    <label for="mail" class="form-label">E-mail :</label>
                    <input name="mail" type="mail" class="form-control" value="<?=htmlentities($mail ?? '')?>" 
