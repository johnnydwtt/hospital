        ...
        <div class="row">
            ...
            <div class="row text-center text-dark  justify-content-center align-items-center">
                ...
                <div class="col-12 col-lg-12 mt-1 d-flex flex-column">
                    <div><span class="tomato fw-lighter mt-2">Nom:</span> <?=$profile->lastname?></div> 
            ...
            <div class="row justify-content-center mt-3">
                ...
                <div class="col-lg-6 mb-3 text-center">
                    <a href="/controllers/modif-profilCtrl.php?id=<?=$profile->id?>"> <button type="button" class="btn btn-primary">modifier</button></a>
                </div>
            </div>
        </div>
    </div>
