                    ...
                    <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                        ...
                        <div class="hexagon-menu clear">
                            <div class="hexagon-item">
                                ...
                                <a class="hex-content">
                                    <span class="hex-content-inner">
                                        ...
                                        <span class="title"><img class="size-img" src="/public/assets/img/logoWeb.png" alt=""></span>
                                    </span>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a class="hex-content" href="/controllers/add-patientCtrl.php">
                                    <span class="hex-content-inner">
                                        <span class="icon">
                                            <i class="fa fa-braille"></i>
                                        </span>
                                        <span class="title">Crée un patient</span>
                                    </span>
                                    <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="hexagon-item">
                                ...
                                <a class="hex-content" href="/controllers/list-appointmentCtrl.php">
                                    <span class="hex-content-inner">
                                        <span class="icon">
                                            <i class="fa fa-clipboard"></i>
                                        </span>
                                        <span class="title">Listes RDV</span>
                                    </span>
                                    <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="hexagon-item">
                                ...
                                <a class="hex-content" href="/controllers/create-appointmentCtrl.php">
                                    <span class="hex-content-inner">
                                        ...
                                        <span class="title">Crée un RDV</span>
                                    </span>
                                    <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
