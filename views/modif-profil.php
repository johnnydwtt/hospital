<main class="container">
    ...
    <form action="<?=htmlspecialchars($_SERVER['PHP_SELF'])?>?id=<?=$profile->id?>" method="post">
        <div class="container d-flex justify-content-center flex-column bg-light shadow-lg mt-2 bg-img">
            <div class="row flex-column align-items-center">
                <div class="col-lg-6 mb-3 mt-3">
                    <label for="lastname" class="form-label">Nom :</label>
                    <input placeholder="lastname" name="lastname" type="text" class="form-control text-muted" value="<?=htmlentities($profile->lastname ?? '')?>" 
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input placeholder="firstname" name="firstname" type="text" class="form-control text-muted" value="<?=htmlentities($profile->firstname ?? '')?>" 
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input name="birthdate" type="date" class="form-control text-muted" value="<?=htmlentities($profile->birthdate ?? '')?>" 
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input placeholder="phone" name="phone" type="tel" class="form-control text-muted" value="<?=htmlentities($profile->phone ?? '')?>" 
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input placeholder="mail" name="mail" type="mail" class="form-control text-muted" value="<?=htmlentities($profile->mail ?? '')?>" 
